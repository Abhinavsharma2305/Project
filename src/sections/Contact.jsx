           ...
           <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            {formData.service && formData.service !== "other" && (
              <div className = "flex flex-col">
                ...
                ${error.budget ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-blue-500`}/>
            ...
            <div className="flex flex-col">
              ...
              onChange={handleChange}
              className={`p-3 rounded-md bg-white/10 border
              ${error.idea ? "border-red-500" : "border-gray-500 "} text-white focus:outline-none focus:border-blue-500`}>
              </textarea>
