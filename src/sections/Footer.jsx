        ...
        <motion.div className="relative z-10 px-4 sm:px-8 lg:px-10 md:py-20 flex flex-col items-center text-center space-y-6 "
          ...
          >
            ...
            <div className="flex gap-5 text-2xl md:text-3xl">
              ...
              whileHover="hover"
              // WhileTap = "tap"
              className="text-gray-300 transition-colours duration-200 inline-flex items-center justify-center"
              >
                <Icon />
            ...
            <p className="text-gray-300 italic max-w-xl">
              "Success is when preparation meets opportunity"
                  ...
                  <p className="text-xs text-gray-400">
                    &copy; {new Date().getFullYear()} Abhinav Sharma . All rights reserved
                  </p>
        </motion.div>
